...
const Navbar = () => {
    ...
    return (
        <nav className="flex  max-w-md justify-between px-4 bg-gradient-to-r from-purple-500 to-pink-500  text-white fixed w-full top-0 left-0 right-0 mx-auto h-[90px] ">
